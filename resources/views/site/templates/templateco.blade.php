        ...
        <div class="row align-items-center mb-5 pb-5">
          <div class="col-lg-7 img-years mb-5 mb-lg-0">
            <span class="experience">
              <span class="years">Consultoria</span>
              <span class="caption">Profissional</span>
            </span>
            <img src="{{url('assets/site/images/cplan.png')}}" alt="Image" class="img-fluid">
          </div>
          <div class="col-lg-4 ml-auto">
            <span class="sub-title">O próximo</span>
            <h3 class="mb-4">Nível.</h3>
            <p class="mb-5">Leve sua empresa para o próximo nível, com nossa consultoria profissional e especializada. </p>
