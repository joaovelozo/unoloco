        ...
        <div class="row align-items-center mb-5 pb-5">
          <div class="col-lg-7 img-years mb-5 mb-lg-0">
            <span class="experience">
              <span class="years">Assessoria</span>
              <span class="caption">Jurídica</span>
            </span>
            <img src="{{url('assets/site/images/juri.png')}}" alt="Image" class="img-fluid">
          </div>
          <div class="col-lg-4 ml-auto">
            <span class="sub-title">Suporte</span>
            <h3 class="mb-4">Jurídico.</h3>
            <p class="mb-5">Sua empresa precisa estar sempre protegida por isso, conte com nossos serviços de assessoria jurídica profissional. </p>
